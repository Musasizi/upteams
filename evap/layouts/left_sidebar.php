		...
		if(($_SESSION['user_role_id'] == 1) || $_SESSION['user_role_id'] == 2 ){?>
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Example Pages">
                ...
                <ul class="sidenav-second-level collapse" id="collapseExamplePages">
                    ...
                    <li>
                        <a href="b.php">Registration Page</a>
                    </li>
                    <li>
                        <a href="#">Forgot Password Page</a>
                    </li>
                    <li>
                        <a href="../views/blank.html">Blank Page</a>
                    </li>
                </ul>
            </li>
            ...
            <?php 
		//only visible to admin and editor @@@2222
		if(($_SESSION['user_role_id'] == 1) || $_SESSION['user_role_id'] == 2 ){?>

            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Evaluation">
                <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseEvaluation"
                    data-parent="#exampleAccordion">
                    <i class="fa fa-fw fa-book"></i>
                    <span class="nav-link-text">Evaluation</span>
                </a>
                <ul class="sidenav-second-level collapse" id="collapseEvaluation">
                    <li>
                        <a href="../views/evaluationF.php">Evalutation Form</a>
                    </li>
                    <li>
                        <a href="../views/results.php">Results</a>
                    </li>
                </ul>
            </li>
