...
$sql="SELECT * FROM answers WHERE category_name = '$categoryName' ORDER BY 'user_id'";
             ...
             while ($DBNames = mysqli_fetch_array($query)) {
                ...
                //      echo '</br>';
                     if ($id ==  $DBNames['id']){
                       ...
                       return "Reply from username: " . $DBNames['first_name']. ' '. $DBNames['last_name'];
                     break;
                     }
...
<head>
    ...
    <link href="../forms/app.css" rel="stylesheet">
