...
<div class="container-fluid">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Health Answers</li>
    </ol>
...
?>
    ...
    <?php  if ($row[1] == "q1") { ?> <label><input type="radio" name="q1" value="c1" disabled
            <?php if ($row[1] == "q1" && $row[2] == "c1" ) {echo $taken;}?> /> Yes
    </label><br /> <?php  } ?>
    ...
    <?php } elseif($row[1] == "q2"){?> <h2>Are you saticified with the services at Allan Galphin</h2>
    ...
    <?php } elseif($row[1] == "q3"){?> <h2>Do you like the way students are attended to at Allan Galphin?</h2>
    ...
    <?php } elseif($row[1] == "q3"){?> <h2>Do services delay at Allan Galpin?</h2>
    ...
    <?php } elseif($row[1] == "q4"){?> <h2>Would you recommend students to continue using Allan Galpin?</h2>


    <?php  if ($row[1] == "q4") { ?> <label><input type="radio" name="q4" value="c1" disabled
            <?php if ($row[1] == "q4" && $row[2] == "c1" ) {echo $taken;}?> /> Yes
    </label><br /> <?php  } ?>

    <?php  if ($row[1] == "q4") { ?> <label><input type="radio" name="q4" value="c2" disabled
            <?php if ($row[1] == "q4" && $row[2] == "c2" ) {echo $taken;}?> /> No </label><br />
    <?php  } ?>

    <?php  if ($row[1] == "q4") { ?> <label><input type="radio" name="q4" value="c3" disabled
            <?php if ($row[1] == "q4" && $row[2] == "c3" ) {echo $taken;}?> /> Not Sure</label><br />
    <?php  } ?>
